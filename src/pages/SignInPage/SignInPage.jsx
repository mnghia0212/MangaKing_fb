      ...
      <div style={{display:'flex', alignItems:'center', justifyContent:'center', background:'#ccc', height:'100vh'}}>
          <div style={{width: '800px', height:'450px', borderRadius:'10px', backgroundColor:'#efefef', display:"flex"}}>
              <WrapperLeft>
                  ...
                  <p style={{fontFamily:'SigniKa Negative', fontSize:'13px'}}>Please sign in or sign up !</p>
                  ...
                  <div style={{marginTop:'15px'}}>
                      ...
                      <p style={{fontSize:'13px', fontFamily:'SigniKa Negative', marginTop:'15px'}}> Don't have an account yet?
