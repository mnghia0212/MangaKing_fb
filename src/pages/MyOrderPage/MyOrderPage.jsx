...
const MyOrderPage = () => {
  ...
  return (
    <Loading isLoading={isLoading || isLoadingCancel}>
      <WrapperContainer>
        <div style={{height: '100%', width: '1270px', margin: '0 auto', padding:'30px 0px'}}>
          <h1 style={{margin:'0px 0px 10px 0px', fontFamily:'Signika Negative', fontSize:'30px', textAlign:'center' }}>MY ORDERS</h1>
          <WrapperListOrder>
            {data?.map((order) => {
              ...
              return (
                <WrapperItemOrder key={order?._id}>
                  <WrapperStatus>
                    ...
                    <div>
                      <span style={{color: 'rgb(255, 66, 78)'}}>Shipping: </span>
                      <span style={{color: 'rgb(90, 32, 193)', fontWeight: 'bold'}}>{`${order.isDelivered ? 'Shipped': 'Unshipped'}`}</span>
                    </div>
                    <div>
                  ...
                  <WrapperFooterItem>
                    <div>
                      <span style={{color: 'rgb(255, 66, 78)', fontFamily:'Signika Negative', fontSize:'15px'}}>Total: </span>
                      <span 
                    ...
                    <ButtonComponent
                        ...
                        textButton={'Cancel the order'}
                        styleTextButton={{ color: '#9255FD', fontSize: '15px', fontFamily:'Signika Negative' }}
                      >
                      </ButtonComponent>
                      <ButtonComponent
