...
const HeaderComponent = ({isHiddenSearch =  false, isHiddenCart = false}) => {
    ...
    const content = (
        <div>
          ...
          <WrapperContentPopup onClick={() => handleClickNavigate('profile')}>Account Information</WrapperContentPopup>
    ...
    <div>
       <WrapperHeader style={{justifyContent: isHiddenSearch && isHiddenCart ? 'space-between' : 'unset'}}>
            ...
            <Col span={7} style={{display: 'flex', gap: '38px', alignItems: 'center'}}>
                ...
                {!isHiddenCart && (
                    <div onClick={() => navigate('/order')} style={{cursor: 'pointer', display:'flex', gap:'10px', alignItems:'center'}}>
